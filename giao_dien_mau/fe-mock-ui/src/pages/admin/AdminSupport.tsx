...
import { supportTickets } from '../../mockAdminData';
...
export default function AdminSupport() {
  ...
  const filteredTickets = supportTickets.filter(t => {
    const matchSearch = t.sender.toLowerCase().includes(searchTerm.toLowerCase()) || t.description.toLowerCase().includes(searchTerm.toLowerCase());
