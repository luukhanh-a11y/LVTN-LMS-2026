...
import { learningProgressData, childrenData } from '../../mockParentData';
...
export default function ParentDashboard() {
  ...
  const progressList = learningProgressData[activeChildId as keyof typeof learningProgressData] || [];
        ...
        <div className="space-y-6">
          <div className="bg-gradient-to-br from-blue-600 to-blue-800 rounded-2xl p-6 shadow-md text-white relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <p className="text-blue-100 font-medium text-sm">Lớp {activeChild.class}</p>
