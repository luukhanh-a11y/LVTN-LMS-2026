...
import { teacherProfileData } from '../mockData';
        ...
        <div className="p-6 md:p-8 flex flex-col sm:flex-row items-center sm:items-start justify-between gap-6 bg-slate-50/50">
          <div className="flex flex-col sm:flex-row items-center sm:items-start gap-6 text-center sm:text-left">
            <div className="relative group">
              <div className="w-24 h-24 bg-blue-100 text-blue-600 rounded-full flex items-center justify-center text-3xl font-bold shadow-sm border-4 border-white">
                {teacherProfileData.fullName.charAt(0)}
              </div>
            ...
            <div className="mt-2">
              <h3 className="text-xl font-bold text-slate-900">{teacherProfileData.fullName}</h3>
              <p className="text-sm text-slate-500 mt-1">{teacherProfileData.role} • {teacherProfileData.department}</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="space-y-5">
              <div className="space-y-1.5">
                ...
                <input type="text" defaultValue={teacherProfileData.fullName} className="w-full px-4 py-2.5 border border-slate-200 rounded-xl text-sm focus:ring-2 focus:ring-blue-500 focus:outline-none bg-slate-50" />
              </div>
              <div className="space-y-1.5">
                <label className="text-sm font-bold text-slate-700">Mã giáo viên (ID)</label>
                <input type="text" defaultValue={teacherProfileData.id} disabled className="w-full px-4 py-2.5 border border-slate-200 rounded-xl bg-slate-100 text-slate-500 cursor-not-allowed font-medium" />
              </div>
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  ...
                  <input type="date" defaultValue={teacherProfileData.dob} className="w-full pl-11 pr-4 py-2.5 border border-slate-200 rounded-xl text-sm focus:ring-2 focus:ring-blue-500 focus:outline-none bg-slate-50" />
                </div>
              </div>
              <div className="space-y-1.5">
                <label className="text-sm font-bold text-slate-700">Giới tính</label>
                <select defaultValue={teacherProfileData.gender} className="w-full px-4 py-2.5 border border-slate-200 rounded-xl text-sm focus:ring-2 focus:ring-blue-500 focus:outline-none bg-slate-50 cursor-pointer">
                  <option>Nam</option>
                  <option>Nữ</option>
                  <option>Khác</option>
                </select>
            ...
            <div className="space-y-5">
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  ...
                  <input type="tel" defaultValue={teacherProfileData.phone} className="w-full pl-11 pr-4 py-2.5 border border-slate-200 rounded-xl text-sm focus:ring-2 focus:ring-blue-500 focus:outline-none bg-slate-50" />
                </div>
              </div>
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  ...
                  <input type="email" defaultValue={teacherProfileData.email} className="w-full pl-11 pr-4 py-2.5 border border-slate-200 rounded-xl text-sm focus:ring-2 focus:ring-blue-500 focus:outline-none bg-slate-50" />
                </div>
              </div>
            </div>
          </div>
